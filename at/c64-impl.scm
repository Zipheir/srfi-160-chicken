...
(define c64vector-copy!
  (case-lambda
    ((to at from)
     (move-memory! (##sys#slot from 1) (##sys#slot to 1) (c64vector-length (##sys#slot from 1)) 0 (* at 8)))
    ((to at from start)
     (move-memory! (##sys#slot from 1) (##sys#slot to 1) (c64vector-length (##sys#slot from 1)) (* start 8) (* at 8)))
