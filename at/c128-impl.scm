...
(define c128vector-copy!
  (case-lambda
    ((to at from)
     (move-memory! (##sys#slot from 1) (##sys#slot to 1) (c128vector-length (##sys#slot from 1)) 0 (* at 16)))
    ((to at from start)
     (move-memory! (##sys#slot from 1) (##sys#slot to 1) (c128vector-length (##sys#slot from 1)) (* start 16) (* at 16)))
